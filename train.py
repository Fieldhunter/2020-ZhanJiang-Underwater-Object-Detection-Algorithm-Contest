...
def _main():
    ...
    if True:
        model.compile(optimizer=RAdam(lr=1e-3), loss={
    ...
    if True:
        ...
        model.compile(optimizer=RAdam(lr=1e-3), loss={'yolo_loss': lambda y_true, y_pred: y_pred}) # recompile to apply the change
